...
class GreedyBestFirstGraphFrontierSpec extends FlatSpec with BeforeAndAfterEach with Matchers {
  ...
  "A frontier" should "replace an existing node with a better one" in {
    val node1 = new Node(null, 'op, "one", 0, 2)
    val node2 = new Node(node1, 'op, "one", 0, 1)
    frontier.add(node1)
    frontier.add(node2)
  ...
  "A frontier" should "not replace an existing node with a worse one" in {
    val node1 = new Node(null, 'op, "one", 0, 1)
    val node2 = new Node(node1, 'op, "one", 0, 2)
    frontier.add(node1)
    frontier.add(node2)
  ...
  "A frontier" should "emit nodes by lowest h value first" in {
    val node1 = new Node(null, 'op, "one", 0, 0)
    val node2 = new Node(node1, 'op, "two", 0, 1)
    val node3 = new Node(node1, 'op, "three", 0, 2)
    frontier.add(node1)
    frontier.add(node3)
    frontier.add(node2)
  ...
  "A frontier" should "accept nodes with same h value but different state" in {
    val node1 = new Node(null, 'op, "one", 0, 0)
    val node2 = new Node(node1, 'op, "two", 0, 1)
    val node3 = new Node(node1, 'op, "three", 0, 1)
    frontier.add(node1)
    frontier.add(node3)
    frontier.add(node2)
