...
class UniformCostGraphFrontierSpec extends FlatSpec with BeforeAndAfterEach with Matchers {
  ...
  "A frontier" should "replace an existing node with a better one" in {
    val node1 = Node(null, 'op, "one", 2, 0)
    val node2 = Node(node1, 'op, "one", 1, 0)
    frontier.add(node1)
    frontier.add(node2)
  ...
  "A frontier" should "not replace an existing node with a worse one" in {
    val node1 = Node(null, 'op, "one", 1, 0)
    val node2 = Node(node1, 'op, "one", 2, 0)
    frontier.add(node1)
    frontier.add(node2)
  ...
  "A frontier" should "emit nodes by lowest g value first" in {
    val node1 = Node(null, 'op, "one", 0, 0)
    val node2 = Node(node1, 'op, "two", 1, 0)
    val node3 = Node(node1, 'op, "three", 2, 0)
    frontier.add(node1)
    frontier.add(node3)
    frontier.add(node2)
  ...
  "A frontier" should "accept nodes with same g value but different state" in {
    val node1 = Node(null, 'op, "one", 0, 0)
    val node2 = Node(node1, 'op, "two", 1, 0)
    val node3 = Node(node1, 'op, "three", 1, 0)
    frontier.add(node1)
    frontier.add(node3)
    frontier.add(node2)
